...
5. It was found by derviation that the variance of recruitment for a cohort would bbe:
...
total_recruitment_by_cohort_1 <- simulate_cohort_return(I_0 = 100, alpha = 2, beta = 2/5
                                                        , lambda_I_0 = 1/30, t = 240, n_sim=1000000)
...
result_cols <- c("Sites in Cohort","Alpha","Beta","Mean Establishment Time Days","Trial Length Days","Expected Recruitment","Simulation 1 Mean","Simulation 2 Mean","Simulation 3 Mean","Simulations Performed")
      ...
      for(lambda_I_0_level in lambda_I_0_levels){
        ...
        for (t_level in t_levels){
          ...
          results_newline[["Expected Recruitment"]] <- expected_recruitment_cohort(
                                                          ...
                                                          t = t_level)
          results_newline[["Simulation 1 Mean"]] <- mean(simulate_cohort_return(
                                                          I_0 = I_0_level, alpha = alpha_level,
                                                          beta = beta_level, lambda_I_0 = lambda_I_0_level,
                                                          t = t_level, n_sims = n_sims_level))
          results_newline[["Simulation 2 Mean"]] <- mean(simulate_cohort_return(
                                                          I_0 = I_0_level, alpha = alpha_level,
                                                          beta = beta_level, lambda_I_0 = lambda_I_0_level,
                                                          t = t_level, n_sims = n_sims_level))
          results_newline[["Simulation 3 Mean"]] <- mean(simulate_cohort_return(
                                                          I_0 = I_0_level, alpha = alpha_level,
                                                          beta = beta_level, lambda_I_0 = lambda_I_0_level,
                                                          t = t_level, n_sims = n_sims_level))
...
write.csv(results_df, file = "C:/Users/mclef/Documents/Research/Clinical Trials/sim results/Cohort Recruitment Distribution/Exponential Establishment/cohort_reruitment_study_1.csv",row.names=FALSE)
