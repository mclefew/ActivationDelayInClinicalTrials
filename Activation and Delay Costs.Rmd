...
ggplot() +
  ...
  xlab("Initiated Sites") +
  ylab("Days to Completion") + 
  ggtitle("Days to Complete Trial - Instantaneous Activation")
...
write.csv(optimal_sets_no_delay, file = "C:/Users/mclef/Documents/Research/Clinical Trials/sim results/Cohort Recruitment Distribution/Exponential Establishment/cohort_reruitment_study_12_opt.csv",row.names=FALSE)
...
write.csv(optimal_sets_no_delay_3, file = "C:/Users/mclef/Documents/Research/Clinical Trials/sim results/Cohort Recruitment Distribution/Exponential Establishment/cohort_reruitment_study_12_opt_2.csv",row.names=FALSE)
